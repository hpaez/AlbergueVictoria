 ...
 * @author DerKow
 */
public class CtrlEntrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        AlbergueDAO objAlbergueDAO = new AlbergueDAO();
        ArrayList <AlbergueVO> listaAlbergue = null;
        
        if(request.getParameter("btnModificarEstado").equals("Modificar Estado")){
